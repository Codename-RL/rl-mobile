  ...
  Widget build(BuildContext context) {
    ...
    return AuthScaffold(
      ...
      bottomArea: Row(
        ...
        children: [
          Text('Sudah punya akun?', style: tt.bodyMedium?.copyWith(color: ct.onPrimaryContainer)),
          TextButton(onPressed: null, child: Text('Masuk', style: tt.labelLarge?.copyWith(color: ct.primary))),
        ],
      ),
    );
  }
